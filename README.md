...
| | | |
| --- | --- | --- |
| **Implementation architecture** | **READY** | 13 adapters, a deterministic engine, 17 conformance suites. `RG-SIM-ONBOARDING-v0.1` passes; all 7 gate conditions ([§61](docs/reference/onboarding.md)) are engine-verified against live GitHub issues. |
