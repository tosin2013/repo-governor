...
| | | |
| --- | --- | --- |
| **Implementation architecture** | **READY** | 13 adapters, a deterministic engine, 15 conformance suites. `RG-SIM-ONBOARDING-v0.1` passes; all 7 gate conditions ([§61](docs/reference/onboarding.md)) are engine-verified against live GitHub issues. |
...
```bash
git clone --branch v0.2.1 https://github.com/tosin2013/repo-governor /tmp/rg
...
conformance/   15 suites — the evidence behind every gate claim
schemas/       manifest v1 JSON Schema
docs/
  adrs/        28 architectural decisions (23 Accepted) + index + ratification review
