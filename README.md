...
| | | |
| --- | --- | --- |
| **Implementation architecture** | **READY** | 14 adapters, a deterministic engine, 17 conformance suites. `RG-SIM-ONBOARDING-v0.1` passes; all 7 gate conditions ([§61](docs/reference/onboarding.md)) are engine-verified against live GitHub issues. |
...
```text
adapters/      14 provider adapters, subprocess protocol, any language
...
| Suite | Asserts |
| --- | --- |
| `layer1.py` | 149 contract checks across 14 adapters |
