...
**Amended by**: [ADR-020](020-agent-supplied-transport-with-adapter-as-normalizer.md), which is still `Proposed`, so this amendment is not yet in force. If it is accepted: transport may live outside the adapter process entirely. "Transport is invisible to the engine" still holds.
**Date**: 2026-08-17
