...
```bash
git clone --branch v0.2.4 https://github.com/tosin2013/repo-governor /tmp/repo-governor
...
| `dolt` | `decision_history` via `adapters/dolt-decisions` | **4 of 16 conformance suites fail** |
...
Expect 16/16 from a fresh clone.
